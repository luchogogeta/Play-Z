"""Ventana de configuración: idioma, tema y arranque con Windows."""
...
class SettingsWindow(tk.Toplevel):
    ...
    def _build(self, theme_name: str) -> None:
        ...
        self.startup_check.grid(row=4, column=0, sticky="w", pady=(0, 22))
        ...
        self.close_btn.grid(row=5, column=0, sticky="e")
    ...
    def apply_theme(self, colors: dict) -> None:
        ...
        for widget in (self.language_label, self.theme_label):
